...
import { getAllBooks, getAllAuthors, getAllGenres, getFeaturedBooks } from "@/helpers/api-util";
  ...
  return (
    <>
      ...
      <div className={styling.Buttons}>
        <button className={styling.Button} onClick={viewGenres}>
          View Genres
        </button>
        <button className={styling.Button} onClick={viewAllBooks}>
          View All Books
        </button>
        <button className={styling.Button} onClick={viewAllAuthors}>
          View All Authors
        </button>
      </div>
    </>
